...
int main() {
    try {
        ...
        arena.createAndAddNpc("Knight", "Galahad", 150, 150);
        arena.createAndAddNpc("Druid", "Merlin", 120, 120);
        arena.createAndAddNpc("Druid", "Gandalf", 110, 110);
        arena.createAndAddNpc("Elf", "Legolas", 200, 200);
        arena.createAndAddNpc("Elf", "Aragorn", 130, 130);
